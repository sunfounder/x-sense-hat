...
def install():
    ...
    do(msg="install setuptools",
        cmd='run_command("sudo pip3 install setuptools")')

# sudo apt-get install python-rpi.gpio python-spidev python-pip python-pil python-numpy
    do(msg="install git",
        cmd='run_command("sudo apt-get install git-core -y")')
    do(msg="install pi gpio pil numpy spi",
    ...
    do(msg="install smbus2",
        cmd='run_command("sudo pip3 install smbus2")')
    do(msg="install bme280",
        cmd='run_command("sudo pip3 install RPi.bme280")')
    do(msg="install pygame",
        cmd='run_command("sudo apt-get install python3-pygame -y")')
...
# sudo pip3 install opencv-contrib-python==4.1.0.25
    ...
    #     do(msg="create .sensor_hat directory",
    #         cmd='run_command("sudo mkdir /home/pi/Pictures/")')
    # if "sensor_hat_picture_file" not in listdir("/home/pi/Pictures"):
    #     do(msg="create .sensor_hat directory",
    #         cmd='run_command("sudo mkdir /home/pi/Pictures/sensor_hat_picture_file")')  
    # if "sensor_hat_time-lapse-shot_file" not in listdir("/home/pi/Pictures"):
    #     do(msg="create .sensor_hat directory",
    #         cmd='run_command("sudo mkdir /home/pi/Pictures/sensor_hat_time-lapse-shot_file")')  

    # do(msg="copy sensor_hat_qmc6310-config",
    #     cmd='run_command("sudo cp ./data/config /home/pi/.qmc6310_config")')
    # do(msg="change directory owner",
    #     cmd='run_command("sudo chown -R pi:pi /home/pi/.qmc6310_config")')

    do(msg="copy sensor_hat_mpu9250-config",
        cmd='run_command("sudo cp ./data/config /home/pi/.mpu9250_config")')
    do(msg="change directory owner",
        cmd='run_command("sudo chown -R pi:pi /home/pi/.mpu9250_config")')

    # print("Setup sensor_hat web-example service") 
    # do(msg="copy sensor_hat web-example file",
    #     cmd='run_command("sudo cp ./bin/sensor_hat-web-example /etc/init.d/sensor_hat-web-example")')
...
setup(
    ...
    description='sensor_hat for Raspberry Pi',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/sunfounder/sensor_hat',
    ...
    keywords='sensor raspberry pi RGB sunfounder',
